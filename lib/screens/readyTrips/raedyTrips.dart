...
class ReadyTrips extends StatefulWidget {
  static const String routeName = "ready trips";

  @override
  State<ReadyTrips> createState() => _Add_placesState();
}

class _Add_placesState extends State<ReadyTrips> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: FutureBuilder(
          future: ApiManger.getReadyTripDetails(),
