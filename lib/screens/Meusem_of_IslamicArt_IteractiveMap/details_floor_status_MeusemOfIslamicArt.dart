...
class DetailsFloorStatusMeusemOfIslamicArt extends StatefulWidget {
  ...
  static const String routeName = "DetailsFloorStatusMeusemOfIslamicArt";
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    image: DecorationImage(
                      image: NetworkImage(data[1].imageLink ?? ""),
                      fit: BoxFit.cover,
                    ),
                  ),
                ),
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              IconButton(
                                  onPressed: () {
                                    stop(data[1].description ?? "");
                                  },
                                  icon: Icon(Icons.pause,
                                      size: 30.w, color: primaryColor))
                            ],
                          ),
                          _buildInfoText("", data[1].description),
                        ],
                      ),
                    ),
                  ),
