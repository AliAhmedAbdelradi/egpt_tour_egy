...
class NumOfPlaceFastTrip extends StatelessWidget {
  final int id;

  NumOfPlaceFastTrip({Key? key, required this.id}) : super(key: key);

  static const String routeName = "NumOfPlaceFastTrip";
